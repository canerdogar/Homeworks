...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None, reg=0.0):
    ...
    #############################################################################
    loss = np.sum(np.square(scores - y))/2 + 0.5 * reg * np.sum(W1 * W1) + 0.5 * reg * np.sum(W2 * W2)
    pass
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
    ...
    #############################################################################
    grads['W2'] = h1_woa.T.dot(scores-y)
    grads['W2'] += reg * W2
    grads['b2'] = np.sum(scores-y, axis=0)
    hidden_layer = (scores-y).dot(W2.T)
    hidden_layer[h1_woa<=0] = 0
    grads['W1'] = X.T.dot(hidden_layer)
    grads['W1'] += + reg * W1
    grads['b1'] = np.sum(hidden_layer, axis=0)
    pass
    #############################################################################
    #                              END OF YOUR CODE                             #
    #############################################################################
