...
public class Hw2Q1 {
	...
	public static DataSet splitData(Instances instances, float ratio, boolean randomize) {
		...
		if (randomize){
			...
			ret.trainingSet.randomize(new java.util.Random(0));
	 ...
	 * @throws Exception
	 */
	public static MultilayerPerceptron trainMLP(Instances trainSet, float learningRate, float momentum, int maxEpoch,String hiddenLayers) throws Exception {
		MultilayerPerceptron mlp = new MultilayerPerceptron();
		mlp.setLearningRate(learningRate);
		mlp.setMomentum(momentum);
		mlp.setTrainingTime(maxEpoch);
